...
#define inpw(port)             readw((void *)port)
#define outpw(port, val)       writew(val, (void *)port)
#define inpdw(port)            readl((void *)port)
#define outpdw(port, val)      writel(val, (void *)port)
