...
rm -rf drivers/target/iscsi drivers/md arch/sparc drivers/watchdog drivers/scsi/qla2xxx tools/power/cpupower
...
git checkout HEAD -- drivers/scsi/qla2xxx tools/power/cpupower
...
git checkout HEAD -- drivers/of/gpio.c drivers/of/gpio.c drivers/regulator/dummy.c drivers/regulator/tps65910-regulator.c drivers/regulator/twl-regulator.c include/linux/regulator/driver.h
